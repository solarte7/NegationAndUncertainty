...
2) Four Python notebooks are provided in this directory to perform validation:
    ...
    - Load_BiLSTM: This script allows us to load a trained BiLSTM-CRF model and validate a set of sentences manually.
...
3) -  Load_BERT: This script allows us to load a trained BERT-based model and validate a set of sentences manually.
